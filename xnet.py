...
'''reference: https://github.com/JosephPB/XNet，https://arxiv.org/abs/1812.00548'''

class XNet(nn.Module):
    """The network used for small-scale X-Ray image segmentation is structured by concatenating two SegNets and incorporating some skip connections，
    """
